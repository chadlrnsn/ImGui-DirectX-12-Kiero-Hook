...
static_assert(sizeof(FSynth2DSliderStyle) == 0x000390, "Wrong size on FSynth2DSliderStyle");
...
static_assert(offsetof(FSynth2DSliderStyle, DisabledThumbImage) == 0x0000C0, "Member 'FSynth2DSliderStyle::DisabledThumbImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, NormalBarImage) == 0x000170, "Member 'FSynth2DSliderStyle::NormalBarImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, DisabledBarImage) == 0x000220, "Member 'FSynth2DSliderStyle::DisabledBarImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, BackgroundImage) == 0x0002D0, "Member 'FSynth2DSliderStyle::BackgroundImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, BarThickness) == 0x000380, "Member 'FSynth2DSliderStyle::BarThickness' has a wrong offset!");
...
static_assert(sizeof(FSynthKnobStyle) == 0x0002E0, "Wrong size on FSynthKnobStyle");
static_assert(offsetof(FSynthKnobStyle, LargeKnob) == 0x000010, "Member 'FSynthKnobStyle::LargeKnob' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, LargeKnobOverlay) == 0x0000C0, "Member 'FSynthKnobStyle::LargeKnobOverlay' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MediumKnob) == 0x000170, "Member 'FSynthKnobStyle::MediumKnob' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MediumKnobOverlay) == 0x000220, "Member 'FSynthKnobStyle::MediumKnobOverlay' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MinValueAngle) == 0x0002D0, "Member 'FSynthKnobStyle::MinValueAngle' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MaxValueAngle) == 0x0002D4, "Member 'FSynthKnobStyle::MaxValueAngle' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, KnobSize) == 0x0002D8, "Member 'FSynthKnobStyle::KnobSize' has a wrong offset!");
