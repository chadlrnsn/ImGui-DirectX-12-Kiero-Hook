...
public:
	...
	class UBodySetup*                             ProcMeshBodySetup;                                 // 0x0528(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x0550(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	TArray<class UBodySetup*>                     AsyncBodySetupQueue;                               // 0x0588(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UProceduralMeshComponent) == 0x0005A0, "Wrong size on UProceduralMeshComponent");
...
static_assert(offsetof(UProceduralMeshComponent, AsyncBodySetupQueue) == 0x000588, "Member 'UProceduralMeshComponent::AsyncBodySetupQueue' has a wrong offset!");
