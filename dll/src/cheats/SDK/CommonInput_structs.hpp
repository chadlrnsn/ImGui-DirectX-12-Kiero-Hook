...
static_assert(sizeof(FCommonInputKeyBrushConfiguration) == 0x0000D0, "Wrong size on FCommonInputKeyBrushConfiguration");
...
static_assert(sizeof(FCommonInputKeySetBrushConfiguration) == 0x0000C0, "Wrong size on FCommonInputKeySetBrushConfiguration");
