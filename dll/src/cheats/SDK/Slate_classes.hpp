...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x0005D0, "Wrong size on UComboBoxWidgetStyle");
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x000570, "Wrong size on UComboButtonWidgetStyle");
